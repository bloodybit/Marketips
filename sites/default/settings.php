 ...
 *
 */
$drupal_hash_salt = '8LYGyQ6K0yices5HWd_9T2ul5eXUAhyWcC12yAbjPm8';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_drupal7jfmtest_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_drupal7jfmtest_dev_default.inc';
}
// </DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/drupal7jfmtest/drupal7jfmtest-settings.inc');
}
